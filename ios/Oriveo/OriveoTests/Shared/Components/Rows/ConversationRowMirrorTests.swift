...
@Suite("ConversationRowMirror", .serialized)
@MainActor
struct ConversationRowMirrorTests {
    ...
    @Test("Mirrored Row Test Avoids Catalog Projection")
    func mirroredRowTestAvoidsCatalogProjection() async throws {
