...
<img src="../../docs/assets/hero.webp" width="100%" alt="Oriveo Community Edition: все модели в одном приложении. 15 провайдеров, 700+ моделей, iOS, Android и веб.">
...
- **Память** — несколько фактов о вас, записанных один раз и подхватываемых в каждом новом разговоре
