...
Файлы `.sse` внутри `recorded/` — это **реально захваченный трафик upstream**, сохранённый байт в
байт таким, каким пришёл: выброшены только заголовки ответа, а в телах никогда не было ключа.
Остальные — написанные вручную фикстуры, прибивающие конкретный путь разбора. Различие важно:
