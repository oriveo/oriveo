...
> [!IMPORTANT]
> Около 38 наборов загружают контрактные фикстуры, резолвя `../../shared` от директории
> Gradle-модуля, поэтому **тесты проходят только в полной копии репозитория** — если скопировать
