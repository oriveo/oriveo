...
skills, настройки и вложения в любом случае пишутся обычным JSON и обычными файлами, так что
...
по 1 300 строк в каждой, и во всех локалях набор ключей одинаковый. Смена языка внутри приложения
