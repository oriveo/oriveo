...
> [!IMPORTANT]
> تحمّل نحو 38 مجموعة اختبار نسخ العقود المرجعية بحل المسار `../../shared` انطلاقا من مجلد وحدة
> Gradle، لذا **لا تنجح الاختبارات إلا في نسخة كاملة من المستودع** — نسخ مجلد `android/` وحده لن
> ينفع.
...
1,300 نص لكل منها، وكل لغة تحمل مجموعة المفاتيح نفسها بالضبط. ويمر تبديل اللغة داخل التطبيق عبر
