...
يتطلب Node 22.22 أو أحدث (انظر [`.nvmrc`](../../web/.nvmrc)). ويأتي npm معه؛ ولا حاجة إلى أي مدير حزم آخر.
...
> [!IMPORTANT]
> تحمّل أكثر من ثلاثين مجموعة اختبار نسخ العقود المرجعية من `../shared`، لذا **لا تنجح الاختبارات
> إلا في نسخة كاملة من المستودع** — نسخ مجلد `web/` وحده لن ينفع.
