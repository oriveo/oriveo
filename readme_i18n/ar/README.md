...
المزود. لا يوجد حساب Oriveo ولا اشتراك، ولا شيء يرفع إلينا تقارير.
...
| **النداءات التي يجريها لحسابه هو** | شيء واحد، في طلبين: فهرس نماذج للقراءة فقط، بلا مفتاح وبلا معرّف مرفق |
...
- **سلوك واحد، ثلاثة عملاء.** طريقة تشكيل الطلب لمزود ونقل وقدرة معيّنة مكتوبة مرة واحدة في
  ...
  في الوقت نفسه.
- **الاتصال الوحيد الذي يقوم به.** يجلب التطبيق فهرس نماذج عاما حتى يعمل نموذج صدر اليوم دون
  تحديث التطبيق. الفهرس للقراءة فقط، ولا يحمل مفتاحا ولا معرّفا، ويمكنك توجيهه إلى مضيفك الخاص.
...
- **خوادم النماذج المحلية** — llama.cpp وOllama وLM Studio وvLLM؛ ويعثر عليها عميلا iOS وAndroid
  على الشبكة المحلية عبر mDNS
...
| التحليلات وتقارير الأعطال | معطّلة افتراضيا — حزمة الويب تتضمن Sentry، وهو صامت بلا DSN | نعم |

تستخدم بُنى نسخة المجتمع بادئة المعرّف `ai.oriveo.community`، فيمكن لواحدة منها أن تجاور نسخة
المتجر دون أن يتشاركا سلسلة مفاتيح أو بيانات محلية. وما تقبله هذه النسخة وما لا تقبله مكتوب في
...
- **لا حساب، ولا شيء يرفع إلينا تقارير.** لا يوجد ما تسجّل الدخول إليه. وتتضمن حزمة الويب Sentry،
  الذي يبقى صامتا ما لم تضبط DSN خاصا بك.
...
Oriveo. الطلب الوحيد الذي ترسله Oriveo لحسابها هو جلب فهرس النماذج العام للقراءة فقط، وهو لا يحمل
مفتاحا ولا محادثة ولا أي معرّف.
...
أو LM Studio أو vLLM أو أي شيء آخر يتحدث أحد تلك البروتوكولات. ويستطيع عميلا iOS وAndroid اكتشاف
خادم كهذا على الشبكة المحلية عبر mDNS؛ أما عميل الويب فيعرض العنوان الافتراضي لكل محرّك ويسبره.
اتصال HTTP المحلي لا يستخدم أي بيانات اعتماد ولا يغادر شبكتك.
...
ليس في هذا المستودع. وإلى أن يوجد، يعمل عميل الويب جيدا كتطبيق سطح مكتب في أي متصفح، ويمكن عادة
تشغيل بنية iOS على جهاز Mac بمعالج Apple silicon.
