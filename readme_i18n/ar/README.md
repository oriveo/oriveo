...
<img src="../../docs/assets/screenshot-providers.webp" width="30%" alt="Oriveo BYOK AI client: قائمة المزودين مع الإنفاق لكل مزود">&nbsp;
<img src="../../docs/assets/screenshot-crosscheck.webp" width="30%" alt="Oriveo multi-model AI client يتحقق من إجابة بنموذج ثان">&nbsp;
<img src="../../docs/assets/screenshot-notes.webp" width="30%" alt="Oriveo, AI chat client يحفظ ردا كملاحظة">

<sub>كل مزود تستخدمه وكم كلّف كل منها · نموذج ثان يتحقق من الأول · رد محفوظ كملاحظة</sub>
