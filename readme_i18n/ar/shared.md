...
نفسها على الملفات ذاتها. فخصوصية مزود ما تُصلَح مرة واحدة. وتغيير عقد يُفشل ثلاث مجموعات اختبار
في الوقت نفسه بدل أن يُشحن على منصتين ويكسر الثالثة.
...
وملفات `.sse` هي **حركة حقيقية ملتقطة من المصدر** وتُترك كما هي بايتا ببايت. فالمحاكاة المكتوبة
يدويا تشفّر ما اعتقدتَ أن المزود يفعله؛ أما البث المسجّل فيشفّر ما فعله فعلا، بما في ذلك ذلك الجزء
المشوّه الذي أرسله يوم الثلاثاء. وحين يحتاج إصلاح في بروتوكول مزود إلى اختبار، فالتسجيل أثمن من
المحاكاة.
...
وتحدّد مجموعتا اختبار iOS وAndroid موقع هذا المجلد بالصعود من ملف الاختبار حتى تجدا `shared/`،
بينما تحلّه مجموعات الويب نسبة إلى مساحة العمل. ولذلك تتطلب جميعها نسخة كاملة من المستودع.
