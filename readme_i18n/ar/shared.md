...
وملفات `.sse` الموجودة تحت `recorded/` هي **حركة حقيقية ملتقطة من المصدر**، محفوظة بايتا ببايت كما
وصلت — أُسقِطت ترويسات الاستجابة وحدها، ولم تحمل الأجسام مفتاحا قطّ. أما البقية فنسخ مرجعية مكتوبة
يدويا تثبّت مسار تحليل بعينه. والفرق مهم: فالمحاكاة المكتوبة
