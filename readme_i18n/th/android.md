...
โฟลเดอร์ และทักษะ ถูกเก็บบนอุปกรณ์ผ่าน Room ส่วน API key ถูกเข้ารหัสด้วยคีย์ที่เก็บอยู่ใน Android
...
flowchart TB
    subgraph ui ["Compose UI"]
        ...
        screens["แชท · หน้าแรก · ผู้ให้บริการ<br/>โน้ต · ทักษะ · ตั้งค่า"]
    end
...
**ฐานข้อมูลสองตัว ไม่ใช่ตัวเดียว** `oriveo.db` เก็บบทสนทนา ข้อความ ไฟล์แนบ โน้ต โฟลเดอร์ ทักษะ
...
| อะไร | อยู่ที่ไหน |
|---|---|
| บทสนทนา ข้อความ ไฟล์แนบ โน้ต โฟลเดอร์ ทักษะ | Room, `oriveo.db` |
...
แล้วเก็บไว้เป็นฟิลด์หนึ่งของ `data.json` ส่วนบทสนทนา ข้อความ โน้ต โฟลเดอร์ ทักษะ การตั้งค่า และไฟล์แนบ
...
> - ปลายทางบริการรีเลย์ (Relay) และเซิร์ฟเวอร์โมเดลในเครื่องยังทำงานได้เต็มที่ และเป็นเส้นทางเดียวที่ยังสมบูรณ์
>
...
> [!IMPORTANT]
> ชุดทดสอบราว 38 ชุดโหลด contract fixture โดยไล่ขึ้นจากไดเรกทอรีทำงานจนกว่าจะเจอ `shared/`
...
สิบหกภาษา: `values/` (อังกฤษ ซึ่งเป็นต้นทาง) บวกไดเรกทอรีโลแคลอีกสิบห้าชุด —
เคียงข้างกับ `values-night` ที่ไม่มีสตริงอยู่เลย — แต่ละชุดมีสตริงราว 1,340 รายการ
และทุกโลแคลมีชุดคีย์เหมือนกันทั้งหมด
