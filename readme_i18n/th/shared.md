...
ไฟล์ `.sse` ใต้ `recorded/` คือ **ทราฟฟิก upstream ที่ดักจับมาจริง** ถูกทิ้งไว้เหมือนเดิมทุกไบต์
ส่วนที่เหลือเป็น fixture ที่เขียนขึ้นเองเพื่อตรึงเส้นทางการ parse เส้นใดเส้นหนึ่ง
...
resolve `../../shared` จากไดเรกทอรีของโมดูล Gradle และชุดทดสอบเว็บ resolve โดยอิงกับเวิร์กสเปซ
