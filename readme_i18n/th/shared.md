...
พฤติกรรมประหลาดของผู้ให้บริการจึงแก้ครั้งเดียว การเปลี่ยนข้อกำหนดจะทำให้ชุดทดสอบสามชุด
ล้มพร้อมกัน แทนที่จะปล่อยของขึ้นสองแพลตฟอร์มแล้วทำแพลตฟอร์มที่สามพัง
...
`client_tool_loop`, `endpoint_route`, `model_route` และคอมไพเลอร์ของไคลเอนต์แต่ละตัว
จะตรวจสอบว่า recipe ตรงกับผู้ให้บริการ ความสามารถ และ transport ก่อนนำไปใช้
โดยปฏิเสธพร้อมเหตุผลที่มีชื่อกำกับ แทนที่จะส่งคำขอที่ไม่มีใครตรวจสอบออกไป
...
ข้อมูลทดสอบมาตรฐาน ได้แก่ ทราฟฟิกการเรียก tool จาก upstream ที่บันทึกไว้
สถานการณ์การจัดเส้นทางและการค้นหา relay snapshot ของ model-facts และหลักฐานความสามารถ
และสถานการณ์ของเอนจินในเครื่อง

ไฟล์ `.sse` คือ **ทราฟฟิก upstream ที่ดักจับมาจริง** และถูกทิ้งไว้เหมือนเดิมทุกไบต์ mock
ที่เขียนขึ้นเองเข้ารหัสสิ่งที่คุณ *เชื่อว่า* ผู้ให้บริการทำ ส่วนสตรีมที่บันทึกไว้เข้ารหัสสิ่งที่
ผู้ให้บริการ *ทำจริง* รวมถึง chunk ผิดรูปที่มันส่งมาในวันอังคารวันนั้นด้วย
เมื่อการแก้โปรโตคอลของผู้ให้บริการต้องการเทสต์สักตัว สิ่งที่บันทึกไว้มีค่ามากกว่า mock

## OriveoProviderKit

Swift package ที่เก็บเคอร์เนลของโปรโตคอล wire ฝั่งผู้ให้บริการ ได้แก่ การประกอบบรรทัด SSE
การ parse chunk แบบ OpenAI-compatible การเข้ารหัสชื่อ tool การปกปิดข้อมูลรับรอง
การจำแนกข้อผิดพลาดจาก upstream การ parse แท็ก thinking การดึงค่าตามเส้นทาง JSON แบบสตรีม
และโปรไฟล์พฤติกรรมประหลาดรายผู้ให้บริการ
...
ไคลเอนต์ฝั่ง Apple แต่ละตัวมีชั้นเชื่อมบาง ๆ ครอบมันไว้ เพื่อให้พฤติกรรมของ wire
...
ชุดทดสอบทั้ง iOS และ Android หาไดเรกทอรีนี้โดยไล่ขึ้นไปจากไฟล์เทสต์จนกว่าจะเจอ `shared/`
ส่วนชุดทดสอบเว็บ resolve โดยอิงกับเวิร์กสเปซ ทั้งสามชุดจึงต้องการ checkout ทั้งที่เก็บโค้ด
