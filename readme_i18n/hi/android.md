...
बातचीत, मैसेज, नोट्स, फ़ोल्डर, skills, प्राथमिकताएँ और अटैचमेंट हर हाल में सादे JSON और सादी फ़ाइलों
...
सोलह भाषाएँ: `values/` (अंग्रेज़ी, स्रोत) और पंद्रह `values-*` डायरेक्टरी, हर एक में क़रीब 1,300
