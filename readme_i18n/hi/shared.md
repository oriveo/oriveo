...
key नहीं थी। सीधे `provider-toolcall/` में पड़ी `.sse` फ़ाइलें हाथ से लिखे fixtures हैं जो किसी एक
ख़ास parse path को pin करती हैं। यह फ़र्क़
...
भी इसी तरह working directory से ऊपर चढ़ती हैं; और वेब suites इसे workspace के सापेक्ष resolve करती
हैं। इसलिए इन सबको रिपॉज़िटरी का पूरा checkout चाहिए।

कोई pull request खोलने से पहले [CONTRIBUTING.md](../../CONTRIBUTING.md) पढ़ें।
